...
export default function TeacherLayout({ children }: TeacherLayoutProps) {
  ...
  const [userEmail, setUserEmail] = useState('teacher@smart.edu');
  ...
  useEffect(() => {
    ...
    if (userStr) {
      try {
        ...
        setUserName(user.full_name || user.username || user.name || 'Teacher');
        setUserEmail(user.email || user.phone || 'teacher@smart.edu');
      } catch (e) {
